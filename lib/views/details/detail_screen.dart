...
//   /// Returns the selected shareType from the prices list
...
//   //   // e.g. "4-SHARING" → API expects "4-sharing"
//   //   return (prices[_selectedPriceIndex!]['share'] as String).toLowerCase();
//   // }
...
//   //   // prices[index]['share'] is like "1 SHARE", "2 SHARE", "3 SHARE", "4 SHARE"
//   //   // API expects: "1-sharing", "2-sharing", "3-sharing", "4-sharing"
//   //   final raw = prices[_selectedPriceIndex!]['share'] as String;
//   //   // Extract the number part only
//   //   final number = raw.replaceAll(RegExp(r'[^0-9]'), '');
//   //   return '$number-sharing';
//   // }

//   // ✅ New getter — uses the exact value from API
//   String get _selectedShareType {
//     if (_selectedPriceIndex == null) return '';
//     final prices = _currentPrices;
//     if (_selectedPriceIndex! >= prices.length) return '';
...
//     setState(() {
//       _userId = AppPreferences.getUserId();
//     });
//   }
...
//           }
//           return {
//             'share': s.shareType.toUpperCase(), // display label e.g. "2 SHARE"
//             'rawShareType': s.shareType, // ✅ exact API value e.g. "2-sharing"
//             'price': price,
//             'priceFormatted': '${_formatPrice(price)}/-',
//           };
//         })
...
//       print('hostelId: ${_hostel!.id}');
//       print('userId: $_userId');
//       print('roomType: $_selectedRoomType');
//       print('shareType: $_selectedShareType');
//       print('bookingType: $_selectedBookingType');
...
//         // // isTrue from the booking response — true means already submitted
...
//               // ── Book Now / Already Submitted Button ─────────────────────
//               Padding(
