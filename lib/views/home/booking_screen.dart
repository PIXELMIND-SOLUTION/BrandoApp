...
////////////////////// New code based on the isTrue field to hide the upgrade button////////////////////////////
...
//         if (data is Map<String, dynamic>) {
//           final raw = data['bookings'];
//           if (raw is List) bookingsList = raw;
//         } else if (data is List) {
//           bookingsList = data;
//         }
...
//             _selectedBooking = list.first;
//             isAC =
//                 list.first.roomType.toLowerCase().contains('ac') &&
//                 !list.first.roomType.toLowerCase().contains('non');
//             selectedPlan = _capitalize(list.first.bookingType);
//             selectedDate = list.first.startDate;
//           }
...
//     final images = _selectedBooking?.hostel.images ?? [];
//     if (images.isEmpty) return null;
//     return '$_baseUrl/${images.first}';
//   }

//   // ── Returns true if the currently selected booking should show Upgrade ──
//   bool get _showUpgradeButton => _selectedBooking?.isTrue ?? false;
...
//               const SizedBox(height: 8),
//               Text(
//                 'You haven\'t booked any hostel yet.\nExplore and find your perfect stay!',
//                 textAlign: TextAlign.center,
//                 style: TextStyle(
//                   fontSize: 13,
...
//           // ── Upgrade Section — only shown when isTrue == true ───────────────
...
class _BookingScreenState extends State<BookingScreen> {
  ...
  // ── Show Upgrade button only when isTrue == false ──────────────────────────
  bool get _showUpgradeButton => !(_selectedBooking?.isTrue ?? false);
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          // ── Upgrade Section — shown only when isTrue == false ──────────────
          if (_showUpgradeButton) ...[
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 12),
              child: Row(
