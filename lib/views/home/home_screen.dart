...
class _HomeScreenState extends State<HomeScreen> {
  ...
  //         image: NetworkImage(
  //           'https://static.vecteezy.com/system/resources/previews/003/050/891/non_2x/hotel-booking-online-reservation-mobile-application-for-renting-vector.jpg',
  //         ),
  //         fit: BoxFit.cover,
  //       ),
  //     ),
  ...
  //               // AC/Non-AC Toggle Button (placed after search bar)
  //               Padding(
